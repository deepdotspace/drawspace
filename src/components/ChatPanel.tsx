...
// Single source of truth shared with the worker allowlist + the canvas
// assistant (see src/ai/models.ts). Sonnet 4.6 is the default — balanced
// cost/capability with the same 1M-token context as Opus 4.8 at ~3x lower
// price. Override by passing your own `models` prop.
const DEFAULT_MODELS: ModelOption[] = MODEL_OPTIONS
